        ...
        <>
            <div className="group/tooltip relative flex">
                <button
                    ...
                    className="flex cursor-pointer items-center justify-center rounded-r-full px-3.5 py-3 text-neutral-700 outline-none transition-colors hover:bg-white hover:text-black"
                >
